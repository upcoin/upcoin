// Copyright (c) 2014 The upcoin developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("upcoin-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("upcoin-smsg-pow"); // Make this thread recognisable
