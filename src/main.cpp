...
unsigned int nStakeMinAge       = 4 * 60 * 60;      // 4 hour min stake age
unsigned int nStakeMaxAge       = 12 * 60 * 60;      // 12 hours max stake age
...
const string strMessageMagic = "upcoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    {
        nSubsidy = 14100 * COIN; //  upcoin's snack premine
    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "upcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "upcoin - VARIABLE POS INTEREST - STEALTH ADDRESSES  ";
        CTransaction txNew;
        txNew.nTime = 1413642390;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x9d9c8ca4e06a1014d7ef2195cd21d1074ec929e63ed728fb1c4f817bd4f37f70"));
        block.print();
